        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="border-t pt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              ...
              <input type="date" id="incidentDate" value={incidentDate} onChange={(e) => setIncidentDate(e.target.value)} max={new Date().toISOString().split("T")[0]} className="w-full p-3 border border-gray-300 rounded mt-1" required />
            </div>
            <div>
